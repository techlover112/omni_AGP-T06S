...
TARGET_BOOTLOADER_BOARD_NAME := AGP-T06s     # From ro.product.board
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 1800000
# BOARD_USES_FULL_RECOVERY_IMAGE := true      # Uncomment this line if you want to remove size restriction
BOARD_FLASH_BLOCK_SIZE := 20000                   # Might be different for your chip
...
DEVICE_RESOLUTION := 800x400                 # The Resolution of your Device
...
TW_SECONDARY_BRIGHTNESS_PATH :=/sys/class/leds/lcd-backlight/brightness   # Set the Path of Logical Units (LUNs) for Storage below (as per your chip/device)
